    ...
    return(
        <div
          ...
          <div
            ...
            <h5
              className="p-0 m-0">Dashboard</h5>
          </div>
          <div
            className="d-flex align-items-center gap-2">
            <div
              className="rounded-5 p-1 bg-secondary bg-opacity-25 shadow-sm" role="button">
              <img
                ...
                width={25}/>
              <span
                className="fw-semibold ps-2">English</span>
            </div>
            <div
            ...
            <div
              className="rounded-5 bg-secondary bg-opacity-25 shadow-sm p-1" role="button">
              <img
                className="rounded-circle"
                src={user}
                alt="user-image"
                ...
                width={30}/>
              <span
                className="ps-2 fw-semibold">Admin</span>
            </div>
          </div>
        </div>
    );
